...
public class PathConstant {
    ...
    public static final String API_BOOKING_OFFICE_BASE_URL = API_CAR_PARK_ADMIN_URL + "/booking-office";
    public static final String API_CAR_BASE_URL = API_CAR_PARK_ADMIN_URL + "/car";
    public static final String API_PARKING_LOT_BASE_URL = API_CAR_PARK_ADMIN_URL + "/parking-lot";
    public static final String API_TICKET_BASE_URL = API_CAR_PARK_ADMIN_URL + "/ticket";
    public static final String API_TRIP_BASE_URL = API_CAR_PARK_ADMIN_URL + "/trip";
